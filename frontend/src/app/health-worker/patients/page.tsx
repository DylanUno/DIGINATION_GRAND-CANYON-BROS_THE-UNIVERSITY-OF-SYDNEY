      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="shadow-soft border-neutral-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-body font-medium text-neutral-700">Total Patients</CardTitle>
            <Users className="h-4 w-4 text-neutral-500" />
          </CardHeader>
          <CardContent>
            <div className="text-h1 font-bold text-trust-blue">{patients.length}</div>
            <p className="text-body-sm text-neutral-500">Registered in system</p>
          </CardContent>
        </Card>
        <Card className="shadow-soft border-neutral-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-body font-medium text-neutral-700">Active Patients</CardTitle>
            <Users className="h-4 w-4 text-health-teal" />
          </CardHeader>
          <CardContent>
            <div className="text-h1 font-bold text-health-teal">
              {patients.filter(p => p.status === "Active").length}
            </div>
            <p className="text-body-sm text-neutral-500">Currently active</p>
          </CardContent>
        </Card>
        <Card className="shadow-soft border-neutral-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-body font-medium text-neutral-700">Pending Review</CardTitle>
            <Users className="h-4 w-4 text-alert-orange" />
          </CardHeader>
          <CardContent>
            <div className="text-h1 font-bold text-alert-orange">
              {patients.filter(p => p.status === "Pending Review").length}
            </div>
            <p className="text-body-sm text-neutral-500">Awaiting attention</p>
          </CardContent>
        </Card>
      </div>
    </div>
